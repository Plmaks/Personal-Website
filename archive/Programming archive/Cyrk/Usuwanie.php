    ...
    <div class="rekordy">
        <?php
            ...
            while ($row = mysqli_fetch_array($q_1)) {
                echo "<div id='rekordy'><form id='rekordy' action='scripts/delete.php'><input type='checkbox' value='$row'> $row[name], $row[surname], $row[function]</input>, <input type='submit' value='delete'> <br></form></div>";
            }
            error_reporting(1);
